...
export const ISRAELI_AF_CLERK: AmbientNpcProfile = {
    id: 'clerk-israeli-af',
    name: 'Israeli AF Clerk',
    portraitUrl: 'https://picsum.photos/seed/israeli-clerk/200',
    scenarios: [
        {
            id: 'hummus-interrogation',
            startNode: 'intro',
            nodes: {
                intro: {
                    npcLine: "Achi, don’t spill this hummus in your car. It’s haram. Where you from anyway?",
                    choices: [
                        { playerLine: "Tel Aviv, bro. Born and raised.", next: 'telAviv' },
                        { playerLine: "Jerusalem. Don’t start.", next: 'jerusalem' },
                        { playerLine: "None of your business, just bag the hummus.", next: 'hostile' }
                    ]
                },
                telAviv: {
                    npcLine: "Sababa. A true local. I got you.",
                    outcomes: [
                        { type: 'reputation', change: 1, description: '+1 rep with clerk.' },
                        { type: 'notification', message: "The clerk gives you a knowing nod.", description: "Notifies player." }
                    ]
                },
                jerusalem: {
                    npcLine: "Jerusalem, eh? Fine. Whatever.",
                    outcomes: [
                        { type: 'notification', message: "The clerk shrugs. He clearly doesn't care.", description: "Notifies player." }
                    ]
                },
                hostile: {
                    npcLine: "Excuse me? Fine, your total is now 10% higher for the attitude.",
                    outcomes: [
                        { type: 'priceMarkup', multiplier: 1.1, duration: 'current-visit', description: '+10% markup today only.' },
                        { type: 'notification', message: "The clerk glares at you while ringing you up.", description: "Notifies player." }
                    ]
                }
            }
        },
        {
            ...
            nodes: {
                intro: {
                    npcLine: 'Yalla, decide fast. I close in five minutes — even if it’s 2 AM.',
                    outcomes: [{ type: 'notification', message: 'The clerk is tapping his fingers impatiently.', description: 'Flavor text.'}]
                }
            }
        },
        // Start of newly added dialogue scenarios
        {
            id: 'israeli-af-flavor-1',
            startNode: 'intro',
            nodes: {
                intro: {
