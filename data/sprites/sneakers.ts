...
export const SPR_SHOE_LOWTOP: SpriteDef = {
    ...
    frames: [
        [
            ...
            '.......oooWWWoddddddWWo.',
            '....oooWWWdWWWWWWWWWWWo.',
            '..ooWWWWWdWWWWWcccWWWWo.',
            '.oWWWWWWWdWWccccccWWWWo.',
            '.oWWWWWWccccccccWWWWWWo.',
...
export const SPR_SHOE_HIGHTOP: SpriteDef = {
    ...
    frames: [
        [
            ...
            '........ooooWWdddddWWo..',
            '.....oooWWWWWdddddWWWo..',
            '..ooWWWWWWdWWWWWWWWWWo..',
            '.oWWWWWWWdWWcccccWWWWo..',
            '.oWWWWWWccccccccWWWWWo..',
            '.owwwwwwwwwwwwwwwwwwwwo.',
            '.oggggggggggggggggggggo.',
            '..oGGGGGGGGGGGGGGGGGGo..',
        ],
...
export const SPR_SHOE_RUNNER: SpriteDef = {
    ...
    frames: [
        [
            ...
            '.........ooooowWWWWWWo..',
            '.....oooWWWWWdWWWWWWWo..',
            '..ooWWWWWcWWdWWcccWWWo..',
            '.oWWWcccccccdcccWWWWWo..',
            '.owwwwwwwwwwwwwwwwwwwwo.',
            '.oggggggggggggggggggggo.',
            '.ogGgGgGgGgGgGgGgGgGggo.',
            '..oGGGGGGGGGGGGGGGGGGo..',
...
export const SPR_SHOE_FOAM: SpriteDef = {
    ...
    frames: [
        [
            ...
            '..oWWoWWoWWoWWWWo..oWo..',
            '..oWWWWWWWWWWWWWo..oWo..',
            '.oWWoWWoWWoWWWWWWo.oWo..',
            '.oWWWWWWWWWWWWWWWWoWWo..',
            '.oWWWWWWWWWWWWWWWWWWWo..',
            '.oWWWWWWWWWWWWWWWWWWWo..',
            '.oWWWWWWWWWWWWWWWWWWWo..',
            '.oWWWWWWWWWWWWWWWWWWWo..',
...
export const SHOE_LOOKS: Record<string, ShoeLook> = {
    ...
    'cyber-runners': look('shoe-knit', cw(['B', 'o'], ['c', 'C'], ['d', 'o'])),
    ...
    'mschef-satans-skateboard': look('shoe-slipon', cw(['d', 'o'], ['r', 'R'], ['o', 'd'])),
    ...
    'nike-mag-self-lacing': look('shoe-hightop', cw(['g', 'G'], ['c', 'C'], ['W', 'c'], { d: 'C' })),
    ...
    'y-dol-4-algorithm-9s': look('shoe-knit', cw(['d', 'o'], ['c', 'C'], ['d', 'o'])),
    ...
    'heelys-prada-slide-offs': look('shoe-slipon', cw(['o', 'd'], ['W', 'w'], ['W', 'g'])),
    ...
    'jordan-1-space-laser': look('shoe-hightop', cw(['o', 'd'], ['c', 'C'], ['l', 'y'], { d: 'c' })),
